...
def drawHelpText(app):
  ...
  y += dy
  drawLabel('So every straight light must contain the numbers 1 - 9.', x, y, align='top-left', size=size)
  y += dy
  drawLabel('Every 3x1x1 "block" in any orientation is also considered a group, and so must have the numbers 1-9', x, y, align='top-left', size=size)
  y += dy
